...
# Launch both Backend (:5000) and Frontend (:5173) together
npm run dev
```
...
npm run dev
```
*The backend runs on `http://localhost:5000` with local SQLite database and environment configuration in `backend/.env`.*
